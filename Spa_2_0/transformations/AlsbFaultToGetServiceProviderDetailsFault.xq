...
declare namespace xf = "http://soa.o2.co.uk/Spa_2_0/transformations/AlsbFaultToGetServiceProviderDetailsFault/";
...
declare function xf:AlsbFaultToGetServiceProviderDetailsFault($fault1 as element(ns2:fault),$transactionId as xs:string)
...
xf:AlsbFaultToGetServiceProviderDetailsFault($fault1,$transactionId)